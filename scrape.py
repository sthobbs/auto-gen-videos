...
class TripAdvisorScrape():
    """
    Scrape trip advisor for the top n=30 attractions in a location.
    """

    def __init__(self, n=30):
        """
        n : int
            number of attractions to scrape (1-30)
        """
    ...
    def get_html(self, url):
        ...
        ----------
        url : str
            the URL to get the HTML code for.
        """
    ...
    def scrape(self, location, verbose=True, helper_url=None):
        ...
        ----------
        location : str
            the location to scrape (e.g. 'Toronto, Ontario', or 'Canada')
        verbose : bool
            whether to print the attractions as they are scraped.
        helper_url : str
            a URL to use instead of searching trip advisor for the location.
            This is useful if the search results are not what you want.

        Returns
        -------
        df : pandas.DataFrame
            a DataFrame of the top n=30 attractions in the location.
        """
